...
public class SimpleMapApp extends PApplet {
	...
	public void setup() {
		...
		ImageMarker imgMarker1 = new ImageMarker(veniceLocation, loadImage("ui/marker_red.png"));
		ImageMarker imgMarker2 = new ImageMarker(berlinLocation, loadImage("ui/marker_gray.png"));
		ImageMarker imgMarker3 = new ImageMarker(lisbonLocation, loadImage("ui/marker_gray.png"));
